...
var CreateComplimentService = /** @class */ (function () {
  ...
  CreateComplimentService.prototype.execute = function (_a) {
    var tag_id = _a.tag_id,
      user_sender = _a.user_sender,
      user_receiver = _a.user_receiver,
      message = _a.message;
    return __awaiter(this, void 0, void 0, function () {
      var complimentsRepositories,
        usersRepositories,
        userReceiverExists,
        compliment;
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            complimentsRepositories = (0, typeorm_1.getCustomRepository)(
              ComplimentsRepositories_1.ComplimentsRepositories,
            );
            usersRepositories = (0, typeorm_1.getCustomRepository)(
              UsersRepositories_1.UsersRepositories,
            );
